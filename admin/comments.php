    ...
    ?>
          <form method="get">
            <div class="form-group">
              ...
              <textarea name="comment" class="form-control" rows="8" cols="80" placeholder="Reply to comment"></textarea>
            </div>
            <input type="submit" name="comment" value="Reply" class="btn btn-primary">
          </form>
        <?php } ?>
          <?php
          ...
          <table class="table table-hover table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span style='color:<?php if($status=='approve'){echo "darkgreen";} else{echo "red";}?>';> <?php echo ucfirst($status); ?> </span></td>
